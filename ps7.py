...
class NewsStory(object):
    """
    Gets guid, title, subject, summary and link of a news story,
    and then stores and returns them.
    """
    ...
    def isWordIn(self, text):
        ...
        for char in text:
            if char in string.punctuation:
                newText += char.replace(char,' ')
            else:
                newText += char
        
        return self.word.lower() in newText.split(' ')
...
class PhraseTrigger(object):
    ...
    def evaluate(self, story):
        return self.phrase in story.getTitle() or self.phrase in \
        story.getSubject() or self.phrase in story.getSummary()
...
SLEEPTIME = 600 #seconds -- how often we poll
...
def main_thread(master):
    ...
    try:
        ...
        triggerlist = readTriggerConfig("C:/Users/sukhbat.lkhagvadorj/Google Drive/EdX Python/PS 7/triggers.txt")
        #print triggerlist
