...
def compPlayHand(hand, wordList, n):
    ...
    while compWord <> None:
        ...
        if compWord == None:
            print 'Unfortunately computer cannot choose more words. Haha!'
            print ''            
            break
        totalScore += getWordScore(compWord, n)
        print '"' + str(compWord) + '" earned ' + \
        str(getWordScore(compWord, n)) + ' points.'
        hand = updateHand(hand, compWord)
        print 'Total score: ' + str(totalScore)
        print ''
    print '*** The game is ended.'    
    print 'Computer has total score of: ' + str(totalScore)
